...
const App = () => {
  ...
  // ]
  // const {likedBtn, savedBtn, likedCount, savedCount} = useContext(Context)
  const { likedBtn, savedBtn, likedCount, savedCount, students } = useContext(Context);
  ...
  return (
    ...
    <div className="p-20">
      ...
      <div className="py-[30px] flex justify-center gap-[50px] items-center">
        <button className="cursor-pointer hover:scale-[1.05] duration-300  w-[100px] p-2 text-white bg-violet-700 font-medium rounded-md ">saved {savedCount}</button>
        <button className="cursor-pointer hover:scale-[1.05] duration-300  w-[100px] p-2 text-white bg-orange-700 font-medium rounded-md ">liked {likedCount}</button>
      </div>
        ...
        {students.map(item =>
          <li key={item.id} className="w-[330px] shadow-lg shadow-blue-700 p-5 rounded-md ">
            ...
            <div className="flex items-center justify-around py-5">
              <button onClick={() => savedBtn(item.id)} className="text-white cursor-pointer hover:scale-[1.3] duration-300 ">
              ...
              <button onClick={() => likedBtn(item.id)} className="text-white cursor-pointer hover:scale-[1.3] duration-300 ">
